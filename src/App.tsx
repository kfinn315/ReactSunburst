...
function App() {
    ...
    return (
        <div className="content">
            ...
            <SunburstContainer dimensions={{ width: svgDimension, height: svgDimension }} getHighlighter={createSunburstHighlighter} rootNode={rootHierarchyNode} colorScale={colorScale} centerColor={centerColor} />
            <div className='data'>
                <h2>Data</h2>
